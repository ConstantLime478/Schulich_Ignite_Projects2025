...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.falling = True
        self.on_ground = False  # Start false
        self.velocity_y = 0
        # Load all player images for animation
        # CHANGE THIS BASED ON YOUR COMPUTER'S FILE PATH STRUCTURE (READ THE README)
        self.image_location = [os.path.join("Flare-Session5" ,"assets", "player1.png"), 
                          os.path.join("Flare-Session5" ,"assets", "player2.png"), 
                          os.path.join("Flare-Session5" ,"assets", "player3.png"), 
                          os.path.join("Flare-Session5" ,"assets", "player4.png")] 
