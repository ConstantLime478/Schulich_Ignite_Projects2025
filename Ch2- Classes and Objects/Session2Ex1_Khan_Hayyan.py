...
leaves_1 = Leaves(160, 220, 100, (156,87,8))

leaves_2 = Leaves(360, 370, 100, (244,123,32))

leaves_3 = Leaves(560, 270, 100, (240,81,51))
...
while True:
    ...
    pygame.draw.rect(screen, leaves_2.color, (leaves_2.x, leaves_2.y, leaves_2.size, leaves_2.size))
    pygame.draw.rect(screen, leaves_3.color, (leaves_3.x, leaves_3.y, leaves_3.size, leaves_3.size))
